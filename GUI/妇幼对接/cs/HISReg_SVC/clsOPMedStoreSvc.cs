  ...
  select seq_ds_recipeaccount_detail.nextval,
   ...
   where b.seriesid_int = ?
     and b.medicineid_chr = c.medicineid_chr(+)";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngSubtractStorage(System.Security.Principal.IPrincipal p_objPrincipal, Int16 m_intSubStorageType, clsDS_StorageDetail_VO[] p_objDetail, ref clsDS_Outstorage_Detail[] m_objOutStorageDetail, out string p_strExcp)
        {
            p_strExcp = string.Empty;
...
where a.medicineid_chr = ? and a.drugstoreid_chr=?";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngRollBackReturnMedInfo(System.Security.Principal.IPrincipal p_objPrincipal, string m_strOperatorid, List<clsReutrnMedEntry> m_objDetailList, out string p_strExcp)
        {
            p_strExcp = string.Empty;
            long lngRes = -1;
            string strSQL;
            ...
            //修改药房库存
            lngRes = this.m_lngSubtractStorage(p_objPrincipal, 2, m_objStorageDetailVoArr, ref m_objOutStorageDetailVoArr, out p_strExcp);
            if (lngRes <= 0)
            {
                ContextUtil.SetAbort();
                return -100;
        ...
        /// <returns></returns>
        public long m_lngGetRecipeStatus(System.Security.Principal.IPrincipal p_objPrincipal, string m_strOutPatientRecipeid, out int m_intStatus)
        {
            long lngRes = 0;
            m_intStatus = 0;
...
order by a.serno_chr desc";
   ...
   where a.sid_int = i.sid_int
     ...
     order by serno_chr desc";
        ...
        /// <param name="dtDuty"></param>
        /// <returns></returns>
        public long m_lngGetTreatMetnFirstByWinID(System.Security.Principal.IPrincipal p_objPrincipal,
            clsStatusWindows_VO windStatus, string strDate, out DataTable p_dtbResult, DataTable dtDuty)
        {
            long lngRes = -1;
...
select p.name_vchr as patientname, r.typename_vchr
 ...
 where a.sid_int = i.sid_int
   ...
   and b.type_int = 5";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetPatientListNotByWinID(System.Security.Principal.IPrincipal p_objPrincipal, clsStatusWindows_VO windStatus, string strDate, out DataTable p_dtbResult, DataTable dtDuty)
        {
            long lngRes = 0;
            p_dtbResult = null;
            strDate = DateTime.Parse(strDate).ToString("yyyy-MM-dd");
 ...
 WHERE m.sid_int=n.sid_int
   ...
   AND m.sid_int=?";
            ...
            int m_intSID, string p_strWinID, out DataTable p_dtOutPatrecIp, out DataTable p_dtItemDe, int flag)
        {
            ...
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetPrintItem");
            if (lngRes < 0)
            {
                return -1;
            }
...
where  trim(A.ITEMSRCID_VCHR)=trim(B.MEDICINEID_CHR(+)) and a.IFSTOP_INT =0  order by ITEMCODE_VCHR";
        ...
        public long m_lngGetEmpName(string EmpNO, string EmpPw, out string EmpName, out string EmpID)
        {
            ...
            {
                com.digitalwave.Utility.clsSymmetricAlgorithm objSym = new clsSymmetricAlgorithm();
                string strPW = objSym.m_strEncrypt(EmpPw, clsSymmetricAlgorithm.enmSymmetricAlgorithmType.DES);
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetCaseHistoryByID(System.Security.Principal.IPrincipal p_objPrincipal, string m_strCaseHistoryID, out DataTable m_objTable)
        {
            long lngRes = 0;
            m_objTable = null;
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetCaseHistoryByID");
            if (lngRes < 0)
            {
                return -1;
            }
   ...
   ORDER BY creatdate DESC ";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetItemsInformationByID(System.Security.Principal.IPrincipal p_objPrincipal, string m_strCaseHistoryID, out DataTable m_objTable)
        {
            long lngRes = 0;
            m_objTable = null;
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetItemsInformationByID");
            if (lngRes < 0)
            {
                return -1;
            }
...
ORDER BY aa.outpatrecipeid_chr";
 ...
 WHERE a.patientid_chr = b.patientid_chr(+)
  ...
  where a.category_int=0 order by a.deptname_vchr";
        ...
        #region 获取药品类型信息
        [AutoComplete]
        public long m_lngGetMedTypeInfo(System.Security.Principal.IPrincipal p_objPrincipal, string m_strID, out DataTable m_objTable)
        {
            long lngRes = 0;
            m_objTable = new DataTable();
            //权限类
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            //检查是否有使用些函数的权限
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetMedTypeInfo");
            if (lngRes < 0) //没有使用的权限
            {
                return -1;
            }
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetDoctorUseMedInfo(System.Security.Principal.IPrincipal objPri, string m_strDepID, string m_strDoctorID, string m_strMedType, string m_strBeginTime, string m_strEndTime, out DataTable m_objTable)
        {
            m_objTable = new DataTable();
            com.digitalwave.security.clsPrivilegeHandleService clsSec = new clsPrivilegeHandleService();
            long lngRes = clsSec.m_lngCheckCallPrivilege(objPri, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetDoctorUseMedInfo");
            if (lngRes < 0)
                return lngRes;
...
SELECT medicinename_vchr, medspec_vchr, assistcode_chr, unitid_chr,
 ...
 WHERE a.default_dept_int = 1 AND a.deptid_chr = b.deptid_chr) e,
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetDoctorUseMedInfoByQuatity(System.Security.Principal.IPrincipal objPri, string m_strDepID, string m_strDoctorID, string m_strMedType, string m_strBeginTime, string m_strEndTime, out DataTable m_objTable)
        {
            m_objTable = new DataTable();
            com.digitalwave.security.clsPrivilegeHandleService clsSec = new clsPrivilegeHandleService();
            long lngRes = clsSec.m_lngCheckCallPrivilege(objPri, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetDoctorUseMedInfo");
...
SELECT medicinename_vchr, medspec_vchr, assistcode_chr, unitid_chr,
 ...
 WHERE a.default_dept_int = 1 AND a.deptid_chr = b.deptid_chr) e,
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetDeptMedFeePercentInfo(System.Security.Principal.IPrincipal p_objPrincipal, string m_strDeptID, string m_strCateID, string m_strBeginTime, string m_strEndTime, out DataTable m_objTable)
        {
            m_objTable = new DataTable();
            long lngRes = 0;
            //权限类
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            //检查是否有使用些函数的权限
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPDoctorPlanSvc", "m_lngGetDeptMedFeePercentInfo");
            if (lngRes < 0) //没有使用的权限
            {
                return -1;
            }
...
";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long GetDoctorUseMedByItemId(System.Security.Principal.IPrincipal objPri, string m_strDepID, string m_strItemID, string m_strMedType, string m_strBeginTime, string m_strEndTime, out DataTable m_objTable)
        {
            m_objTable = new DataTable();
            ...
            {
                com.digitalwave.security.clsPrivilegeHandleService clsSec = new clsPrivilegeHandleService();
                lngRes = clsSec.m_lngCheckCallPrivilege(objPri, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "GetDoctorUseMedByItemId");
                if (lngRes < 0)
                    return lngRes;
       ...
       a.lastchange_dat, 
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetWindowInfoByMedstoreid(System.Security.Principal.IPrincipal m_objPrincipal, string m_strMedStoreid, out DataTable m_bjTable)
        {
            long lngRes = 0;
            m_bjTable = null;

            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(m_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetWindowInfoByMedstoreid");
            if (lngRes < 0)
            {
                return -1;
            }
       ...
       where a.medstoreid_chr = ?";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetDataByMedStoreID(System.Security.Principal.IPrincipal m_objPrincipal, string m_strMedStoreID, string m_strCreateDate, ref List<clsWindowsInfo> m_objWindowList, ref List<clsWindowsInfo> m_objSendWindowsList)
        {
            long lngRes = 0;
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(m_objPrincipal, "com.digitalwave.iCare.middletier.HIS.clsOPMedStoreSvc", "m_lngGetDataByMedStoreID");
            if (lngRes < 0)
            {
                return -1;
            }
...
";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngGetespecialwin(System.Security.Principal.IPrincipal p_objPrincipal, string deptid, string medid, out clsMedStoreWindowsVo objMedStoreVo)
        {
            string winid = "";
            int waitno = 1;
            DataTable dt = new DataTable();
        ...
        /// <returns></returns>
        [AutoComplete]
        public long lngGetSendWindowInfoByWindowid(System.Security.Principal.IPrincipal p_objPrincipal, string m_strMedStoreid, string m_strWindowid, ref clsMedStoreWindowsVo m_objWindowsVo)
        {
            long lngRegs = 0;
            //权限类
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
 ...
 order by numcount";
        ...
        /// <returns></returns>
        [AutoComplete]
        public long lngGetSendWindowInfo(System.Security.Principal.IPrincipal p_objPrincipal, string m_strMedStoreid, bool CheckScope, ref clsMedStoreWindowsVo m_objWindowsVo, bool m_blnWindowType)
        {
            long lngRegs = 0;
            //权限类
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
        ...
        [AutoComplete]
        public long lngGetSpecialSendWindowInfo(System.Security.Principal.IPrincipal p_objPrincipal, string m_strMedStoreid, bool CheckScope, ref clsMedStoreWindowsVo m_objWindowsVo, bool m_blnWindowType)
        {
            long lngRegs = 0;
            //权限类
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
