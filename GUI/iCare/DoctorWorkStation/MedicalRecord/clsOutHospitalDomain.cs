...
namespace iCare
{
	...
	public class clsOutHospitalDomain
	{
        ...
        {
            com.digitalwave.DiseaseTrackService.clsOutHospitalService objServ =
                    (com.digitalwave.DiseaseTrackService.clsOutHospitalService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.DiseaseTrackService.clsOutHospitalService));
