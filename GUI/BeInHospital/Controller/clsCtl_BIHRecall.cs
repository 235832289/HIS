...
namespace com.digitalwave.iCare.gui.HIS
{
	...
	/// 创建时间： 2004-09-06
	/// </summary>
	public class clsCtl_BIHRecall: com.digitalwave.GUI_Base.clsController_Base
	{
		#region 变量
		...
		#region 设置窗体对象
		com.digitalwave.iCare.gui.HIS.frmBIHRecall m_objViewer;
		/// <summary>
		/// 设置窗体对象
		/// </summary>
		...
		public override void Set_GUI_Apperance(com.digitalwave.GUI_Base.frmMDI_Child_Base frmMDI_Child_Base_in)
		{
			...
			m_objViewer = (frmBIHRecall)frmMDI_Child_Base_in;
		}
		#endregion
...
//		#endregion
		...
		public void m_cmdRecall()
		{
			...
			try
			{
				lngReg =m_objRegister.m_lngRecallHospital(objPatientVO);
			}
			catch (Exception e)
			{
