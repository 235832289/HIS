...
{   
   ...
   /// </summary>
    class clsCtl_BIHRegisterStatistics:com.digitalwave.GUI_Base.clsController_Base
    {
        ...
        com.digitalwave.iCare.gui.HIS.frmBIHRegisterStatistics m_objViewer;
        private string m_strStartPatch = "";
        ...
        public void m_mthShowBIHStatistics()
        {
            ...
            rptBIHRegisterStatistics.Load(m_strStartPatch + "Report\\rptBeInHospital.rpt");
        ...
        internal void m_FillCboPatientType()
        {
            ...
            this.m_strStartPatch = Application.StartupPath + "\\";
        }
    }
}
