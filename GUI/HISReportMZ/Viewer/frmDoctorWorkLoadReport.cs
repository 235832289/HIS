...
namespace com.digitalwave.iCare.gui.HIS.Reports
{
	...
	public class frmDoctorWorkLoadReport :com.digitalwave.GUI_Base.frmMDI_Child_Base
	{
		...
		{
            this.objController = new com.digitalwave.iCare.gui.HIS.Reports.clsCtl_DoctorWorkLoadReport();
...
//		}
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
		    ...
		    ((clsCtl_DoctorWorkLoadReport)this.objController).m_mthPrint(e,this.StrFlag);
		...
		private void printDocument1_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			((clsCtl_DoctorWorkLoadReport)this.objController).m_mthBeginPrint(this.StrFlag);
			}
