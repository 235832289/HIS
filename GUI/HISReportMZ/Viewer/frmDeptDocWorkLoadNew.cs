...
namespace com.digitalwave.iCare.gui.HIS.Reports
{
	...
	public class frmDeptDocWorkLoadNew :com.digitalwave.GUI_Base.frmMDI_Child_Base
	{
		...
		{
            this.objController = new com.digitalwave.iCare.gui.HIS.Reports.clsControlDeptDocWorkLoadNew();
		...
		{
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthPrint(e,this.StrFlag);
		}
		...
		private void printDocument1_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthBeginPrint(this.StrFlag);
		}
