...
namespace com.digitalwave.iCare.gui.HIS.Reports
{
	...
	public class frmCheckOutOfDay : com.digitalwave.GUI_Base.frmMDI_Child_Base
	{
        ...
        /// 是否收费员日结简表
        /// </summary>
        public bool m_blnSimple = false;
        public void m_mthShowSimple()
        {
            m_blnSimple = true;
            this.Show();
        }
		...
		private void InitializeComponent()
		{
            ...
            this.panel2.Size = new System.Drawing.Size(772, 364);
            ...
            this.ctlprintShow2.Size = new System.Drawing.Size(772, 364);
		...
		{
            if (Hospital_No == "00001")
			{
                if (this.m_blnReportStyle == true)
                {
                    ((clsControlCheckOutOfDay)this.objController).printPageFS(e);
                }
                else
                {
                    ((clsControlCheckOutOfDay)this.objController).printPageLJ(e);
                }
			}
			else
			{
				((clsControlCheckOutOfDay)this.objController).printPageMB(e);
			}
		...
		{
            frmCheckQuection frmQc = new frmCheckQuection();
            if (frmQc.ShowDialog() == DialogResult.Yes)
			{
                if (frmQc.intCheckFlag == 0)
                {
                    ((clsControlCheckOutOfDay)this.objController).CheckData();
                }
                else
                {
                    ((clsControlCheckOutOfDay)this.objController).CheckDataByDate(frmQc.strCheckDate);
                }
			}
