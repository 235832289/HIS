...
namespace com.digitalwave.iCare.gui.HIS.Reports
{
    ...
    /// 门诊药房发药工作量统计报表
    /// </summary>
    public class clsCtl_Report_SendMedicine : com.digitalwave.GUI_Base.clsController_Base
    {
        #region 全局变量
        /// <summary>
        /// 模块控制类
        /// </summary>
        private clsDcl_Report_SendMedicine m_objDomain = null;
        /// <summary>
        /// 控制窗体对象
        /// </summary>
        private frmSendMedicineReport m_objViewer = null;
        /// <summary>
        /// 配药员工ID
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public clsCtl_Report_SendMedicine()
		{
            m_objDomain = new clsDcl_Report_SendMedicine();
		}
        #endregion
        ...
        public override void Set_GUI_Apperance(com.digitalwave.GUI_Base.frmMDI_Child_Base frmMDI_Child_Base_in)
        {
            ...
            m_objViewer = (frmSendMedicineReport)frmMDI_Child_Base_in;
        }
        #endregion
        ...
        public long m_mthGetSendMedicine(out DataTable m_objTable)
        {
            long lngRes = 0;
            lngRes = this.m_objDomain.m_lngGetSendMedicine(out m_objTable);
            return lngRes;
        }
        #endregion
        ...
        /// 发药处方信息
        /// </summary>
        public void m_mthSelectSendMedicine()
        {
            long lngRes = 0;
            p_strMedstoreid = this.m_objViewer.m_cboMedStore.SelectItemValue.ToString();
            ...
            lngRes = this.m_objDomain.m_lngSelectSendMedicine(p_dtpBegin, p_dtpEnd, p_strMedstoreid,p_strTreatEmp, out m_dtbResult);
            if (lngRes > 0)
            {
                this.m_objViewer.m_dgvSendMedicine.DataSource = m_dtbResult;
        ...
        public void m_mthExploreData()
        {
            ...
            //    }
            //}
            if (this.m_objViewer.m_dgvSendMedicine.Rows.Count > 0)
            {
                com.digitalwave.iCare.gui.HIS.clsPub.m_mthExportToExcel(this.m_objViewer.m_dgvSendMedicine);
            }
        }
        #endregion
        ...
        internal void m_mthGetEmpData()
        {
            ...
            long lngRes = 0;
            lngRes = this.m_objDomain.m_mthGetSendEmp(strMedNameid, out m_objResult);
