...
{
    class clsCtlCheckOutOfDay_BM : com.digitalwave.GUI_Base.clsController_Base
    {
        ...
        #region 设置窗体对象
        com.digitalwave.iCare.gui.HIS.Reports.frmCheckOutOfDay_BM m_objViewer;
        /// <summary>
        /// 设置窗体对象
        /// </summary>
        ...
        public override void Set_GUI_Apperance(com.digitalwave.GUI_Base.frmMDI_Child_Base frmMDI_Child_Base_in)
        {
            ...
            m_objViewer = (frmCheckOutOfDay_BM)frmMDI_Child_Base_in;
        }
        #endregion
        ...
        internal void GetData()
        {
            ...
            if (m_objViewer.m_intMode == 0)
            {
                if (intcomand == 0)
                {
                    ...
                    m_objDomain.GetCheckOutData(strCheckManID, checkDate, this.m_objViewer.m_rptId, out dtCheckOut, out dtDiffSum);
                    m_objDomain.m_mthGetbalancerepeatinvoinfo(strCheckManID, checkDate, out this.m_strInvoArr, intcomand, out m_decInvoMny);
                ...
                else
                {
                    ...
                    m_objDomain.GetCheckOutHistory(strCheckDate, strCheckManID, this.m_objViewer.m_rptId, out dtCheckOut,out dtDiffSum);
                    m_objDomain.m_mthGetbalancerepeatinvoinfo(strCheckManID, strCheckDate, out this.m_strInvoArr, intcomand, out m_decInvoMny);
            ...
            {
                m_objDomain.GetCheckOutData(this.m_objViewer.m_cboStatDateType.SelectedIndex, m_objViewer.m_cboCheckMan.SelectItemValue, m_objViewer.m_datBeginTime.Value.ToString("yyyy-MM-dd 00:00:00"), m_objViewer.m_datEndTime.Value.ToString("yyyy-MM-dd 23:59:59"), m_objViewer.m_rptId, out dtCheckOut, out dtDiffSum);
                m_objDomain.m_mthGetbalancerepeatinvoinfo(this.m_objViewer.m_cboCheckMan.SelectItemValue, m_objViewer.m_datBeginTime.Value.ToString("yyyy-MM-dd 00:00:00"), m_objViewer.m_datEndTime.Value.ToString("yyyy-MM-dd 23:59:59"), out this.m_strInvoArr, this.m_objViewer.m_cboStatDateType.SelectedIndex);
            }
        ...
        private void SetDatawindow(DataRow StatisticsRow)
        {
            ...
            //this.m_objViewer.m_dwShow.Modify("sum_other.text = '￥" + StatisticsRow["门诊社保记账"].ToString() + "'");
            ...
            {
                this.m_objViewer.m_dwShow.Modify("t_date.text = '" + Convert.ToDateTime(this.m_objViewer.m_datEndTime.Value.ToString("yyyy-MM-dd")).ToShortDateString() + "'");
            }
