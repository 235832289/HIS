...
namespace com.digitalwave.iCare.gui.HIS.Reports
{
    ...
    public class clsDomainControl_Register : com.digitalwave.GUI_Base.clsDomainController_Base
    {
        ...
        public long GetCheckOutData(string OPREMPID, string strDate, string strRptId, out DataTable dtCheckOut, out DataTable dtDiffSum)
        {
            ...
            com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc objSvc =
                (com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc));
            long LngArg = objSvc.GetCheckOutData(p_objPrincipal, OPREMPID, strDate, strRptId, out dtCheckOut, out dtDiffSum);
            return LngArg;
        }

        public long GetCheckOutData(int intMode, string OPREMPID, string strStartDate, string strEndDate, string strRptId, out DataTable dtCheckOut, out DataTable dtDiffSum)
        {
            System.Security.Principal.IPrincipal p_objPrincipal = null;
            com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc objSvc =
                (com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc));
            long LngArg = objSvc.GetCheckOutData(p_objPrincipal, intMode, OPREMPID, strStartDate, strEndDate, strRptId, out dtCheckOut,out dtDiffSum);
            return LngArg;
        }
        ...
        public long GetCheckOutHistory(string strDate, string BALANCEEMP, string strRptId, out DataTable dtCheckOut,out DataTable dtDiffSum)
        {
            System.Security.Principal.IPrincipal p_objPrincipal = null;
            com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc objSvc =
                (com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc));
            long LngArg = objSvc.GetCheckOutHistory(p_objPrincipal, strDate, BALANCEEMP, strRptId, out dtCheckOut, out dtDiffSum);
            return LngArg;
        }
        #endregion
        ...
        /// <returns></returns>
        public long m_lngGetCheckedOutDataByCondition(int m_intStatDateType,string m_strCheckManID,string m_strBalanceDeptID, string m_strBeginTime, string m_strEndTime, string strRptId, ArrayList fysfcdeptidARR, out DataTable m_dtCheckOutData,out DataTable dtTemp)
        {
            com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc objSvc =
             (com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.iCare.middletier.HIS.Reports.clsRegisterSvc));
            long lngRes = objSvc.m_lngGetCheckedOutDataByCondition(objPrincipal, m_intStatDateType, m_strCheckManID, m_strBalanceDeptID, m_strBeginTime, m_strEndTime, strRptId, fysfcdeptidARR, out m_dtCheckOutData, out dtTemp);
            return lngRes;
        }
        #region 门诊收费查询模块
        #region 根据时间段获取发票数据
        ...
        public void m_mthGetbalancerepeatinvoinfo(string BalanceEmp, string BalanceTime, out string[] InvonoArr, int status, out decimal[] invoMoneyArr)
        {
            com.digitalwave.iCare.middletier.HIS.Reports.clsOPChargeSvc objSvc =
                (com.digitalwave.iCare.middletier.HIS.Reports.clsOPChargeSvc)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.iCare.middletier.HIS.Reports.clsOPChargeSvc));
            objSvc.m_mthGetbalancerepeatinvoinfo(BalanceEmp, BalanceTime, out InvonoArr, status, out invoMoneyArr);
