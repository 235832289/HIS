...
namespace com.digitalwave.iCare.gui.HIS
{
    ...
    public class clsCtl_Report : com.digitalwave.GUI_Base.clsController_Base
    {
        ...
        public void m_mthRptInvoiceRefundment(string BeginDate, string EndDate, string OperCode, ArrayList DeptIDArr, DataGridView dv, out DataTable dtInvoice, out DataTable dtPayment, out decimal decTotalMoney, out decimal decXj, out decimal decZp, out decimal decYhk, out decimal decQt, out decimal decWx2, out decimal decZfb)
        {
            decTotalMoney = 0;
            decXj = 0;
            decZp = 0;
