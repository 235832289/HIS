            ...
            try
            {
                ...
                string strSQL = @" select a.orderdicid_chr, a.name_chr, a.des_vchr, a.usercode_chr, a.wbcode_chr,
                                      ...
                                      from t_bse_bih_orderdic a, 
                                           (
	   	                                    select a.orderdicid_chr, sum(round(b.qty_int * (case c.ipchargeflg_int when 1 then round (c.itemprice_mny / c.packqty_dec,4) else c.itemprice_mny end), 2)) as totalmny
		   	                                  from t_bse_bih_orderdic a,
        ...
        public long m_lngGetChargeItemByOrderID(string OrderID, string PayTypeID, out DataTable dt)
        {
            ...
            try
            {
                ...
                string strSQL = @" select c.itemid_chr, c.itemname_vchr, c.itemcode_vchr, c.itempycode_chr,
                                           ...
                                           c.itemprice_mny, c.itemunit_chr, c.itemopunit_chr, c.itemipunit_chr,
                                           ...
                                           d.precent_dec, round (c.itemprice_mny / c.packqty_dec,4) as submoney, e.putmedtype_int,
