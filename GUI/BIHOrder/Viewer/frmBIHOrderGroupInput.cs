...
namespace com.digitalwave.iCare.BIHOrder
{
    public partial class frmBIHOrderGroupInput : com.digitalwave.GUI_Base.frmMDI_Child_Base //GUI_Base.dll
    {
        ...
        /// 医嘱调用界面返回的医嘱数组
        /// </summary>
        public ArrayList m_arrGroupOrder = null;
        /// <summary>
        /// 身份ID
        /// </summary>
        ...
        /// <param name="StopControl"></param>
        /// <param name="DeableMedControl"></param>
        public frmBIHOrderGroupInput(clsBIHOrderGroup[] m_arrGroup, clsBIHOrder m_BIHOrder, Hashtable m_OrderCate, DataGridView m_dgOrder, clsSPECORDERCATE m_SpecateVo, string strFindCode, int m_intClass, int m_intType, bool StopControl, bool DeableMedControl, ctlBIHOrderDetail p_ctlOrder)
        {
            InitializeComponent();
