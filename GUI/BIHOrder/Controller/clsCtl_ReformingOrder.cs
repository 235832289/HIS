			...
			switch(m_objViewer.m_intType)
			{
				case 3:
					...
					foreach(clsBIHOrder objItem in alItem)
					{
						...
						try
						{
							lngRes =m_objManage.m_lngStopOrder(objItem,m_strOperatorID,m_strOperatorName,true);;
						}
				...
				case 4:
					...
					foreach(clsBIHOrder objItem in alItem)
					{
						...
						try
						{
							lngRes =m_objManage.m_lngRetractOrder(objItem,m_strOperatorID,m_strOperatorName,true);
						}
						catch//(System.Exception e)
						{
