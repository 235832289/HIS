...
group by b.groupname_vchr";
        ...
        public long m_mthGetCount(string m_strCheckManID,string m_strDeptID,string BeginDate, string EndDate, out DataTable m_dtZFS,out DataTable m_dtFFS)
        {
            ...
            if (m_strCheckManID == string.Empty)
            {
                ...
                {
//                    strSQL = @"select   decode(d.groupname_vchr,null,'未定义组',d.groupname_vchr) as groupname_vchr, sum (decode (a.status_int,
//                                                2, -1,
//                                                1
//                                               )) as 正方
//            from t_opr_outpatientrecipeinv a,
...
//        group by d.groupname_vchr";
           ...
           where a.chargeno_chr = b.chargeno_chr
             ...
             and c.groupid_chr = d.groupid_chr(+)
        group by d.groupname_vchr";
//                    strSQL1 = @"select   decode(d.groupname_vchr,null,'未定义组',d.groupname_vchr) as groupname_vchr, sum (decode (a.status_int,
//                                                2, -1,
//                                                1
//                                               )) as 副方
//            from t_opr_outpatientrecipeinv a,
...
//                 d.groupname_vchr
//                ) as groupname_vchr,
//         sum (decode (e.status_int, 2, -1, 1)) as 就诊人数,
...
//                 d.groupname_vchr
//                ) as groupname_vchr,
//         sum (decode (a.status_int, 2, -1, 1)) as 就诊人数
//     from t_opr_outpatientrecipeinv a,
//         t_opr_reciperelation b,
//         t_opr_outpatientrecipe c,
//         t_bse_groupdesc d,
