...
//        /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetScienceStatByCondition(System.Security.Principal.IPrincipal p_objPrincipal,string p_strDatFrom,string p_strDatTo,
...
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetScienceStatByCondition");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
        ...
        //#region 查询所有的工作组信息 
        //[AutoComplete]
        //public long m_lngGetAllWorkGroupInfo(System.Security.Principal.IPrincipal p_objPrincipal,out DataTable p_dtbResult)
        //{
        //    long lngRes = 0;
        //    p_dtbResult = null;

        //    clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
        //    lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllWorkGroupInfo");
        //    if(lngRes < 0)
        //    {
        //        return -1;
        //    }
        ...
        //#region 查询所有的工作组信息
        //[AutoComplete]
        //public long m_lngGetAllWorkGroupInfo(System.Security.Principal.IPrincipal p_objPrincipal,out clsLisWorkGroup_VO[] p_objResultArr)
        //{
        //    long lngRes = 0;
        //    p_objResultArr = null;
		...
		#region 新增工作组 
		[AutoComplete]
		public long m_lngAddNewWorkGroup(System.Security.Principal.IPrincipal p_objPrincipal,clsLisWorkGroup_VO p_objRecord)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngAddNewWorkGroup");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		#region 更新工作组信息
		[AutoComplete]
		public long m_lngModifyWorkGroup(System.Security.Principal.IPrincipal p_objPrincipal,clsLisWorkGroup_VO p_objRecord)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngModifyWorkGroup");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		#region 删除工作组信息 
		[AutoComplete]
		public long m_lngDelWorkGroup(System.Security.Principal.IPrincipal p_objPrincipal,string p_strWorkGroupID,string p_strStatus)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngDelWorkGroup");
			if(lngRes < 0)
			{
				return -1;
			}
...
//        #region 获取所有的统计组信息
//        [AutoComplete]
//        public long m_lngGetAllStatGroupInfo(System.Security.Principal.IPrincipal p_objPrincipal,out clsLisStatGroup_VO[] p_objResultArr)
//        {
//            long lngRes = 0;
//            p_objResultArr = null;

//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllStatGroupInfo");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        [AutoComplete]
//        public long m_lngGetAllStatGroupUnitInfo(System.Security.Principal.IPrincipal p_objPrincipal,out clsLisStatGroupUnit_VO[] p_objResultArr)
//        {
//            long lngRes = 0;
//            p_objResultArr = null;

//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllStatGroupUnitInfo");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
		...
		#region 新增统计组基本信息 
		[AutoComplete]
		public long m_lngAddNewStatGroupBaseInfo(System.Security.Principal.IPrincipal p_objPrincipal,clsLisStatGroup_VO p_objRecord)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngAddNewStatGroupBaseInfo");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		[AutoComplete]
		public long m_lngAddNewStatGroupUnit(System.Security.Principal.IPrincipal p_objPrincipal,clsLisStatGroupUnit_VO p_objRecord)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngAddNewStatGroupUnit");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		#region 新增统计组及其明细 
		[AutoComplete]
		public long m_lngAddNewStatGroup(System.Security.Principal.IPrincipal p_objPrincipal,clsLisStatGroup_VO p_objStatGroup,
			clsLisStatGroupUnit_VO[] p_objStatGroupUnitArr)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngAddNewStatGroup");
			if(lngRes < 0)
			{
				return -1;
			}
			
			lngRes = m_lngAddNewStatGroupBaseInfo(p_objPrincipal,p_objStatGroup);
			if(lngRes > 0)
			{
				for(int i=0;i<p_objStatGroupUnitArr.Length;i++)
				{
					...
					lngRes = m_lngAddNewStatGroupUnit(p_objPrincipal,p_objStatGroupUnitArr[i]);
				}
			}
			return lngRes;
		}
...
//        [AutoComplete]
//        public long m_lngGetApplUnitByStatGroupID(System.Security.Principal.IPrincipal p_objPrincipal,string p_strStatGroupID,
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetApplUnitByStatGroupID");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
		...
		#region 更新统计组基本信息
		[AutoComplete]
		public long m_lngSetStatGroupBaseInfo(System.Security.Principal.IPrincipal p_objPrincipal,clsLisStatGroup_VO p_objRecord)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngSetStatGroupBaseInfo");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		[AutoComplete]
		public long m_lngDelStatGroupUnitByStatGroupID(System.Security.Principal.IPrincipal p_objPrincipal,string p_strStatGroupID)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngDelStatGroupUnitByStatGroupID");
			if(lngRes < 0)
			{
				return -1;
			}
		...
		#region 更新统计组及明细
		[AutoComplete]
		public long m_lngModifyStatGroup(System.Security.Principal.IPrincipal p_objPrincipal,clsLisStatGroup_VO p_objStatGroup,
			clsLisStatGroupUnit_VO[] p_objStatGroupUnitArr)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngModifyStatGroup");
			if(lngRes < 0)
			{
				return -1;
			}
			...
			try
			{
				lngRes = m_lngSetStatGroupBaseInfo(p_objPrincipal,p_objStatGroup);
				if(lngRes > 0)
				{
					lngRes = m_lngDelStatGroupUnitByStatGroupID(p_objPrincipal,p_objStatGroup.m_strSTAT_GROUP_ID_CHR);
					if(lngRes > 0)
					{
						for(int i=0;i<p_objStatGroupUnitArr.Length;i++)
						{
		...
		#region 删除统计组 
		[AutoComplete]
		public long m_lngDelStatGroup(System.Security.Principal.IPrincipal p_objPrincipal,string p_strStatGroupID)
		{
			long lngRes = 0;

			clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
			lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngDelStatGroup");
			if(lngRes < 0)
			{
				return -1;
			}
...
//        #region 工作量统计汇总
//        [AutoComplete]
//        public long m_lngGetStatTotalReport(System.Security.Principal.IPrincipal p_objPrincipal,string p_strDatFrom,string p_strDatTo,string p_strOprID,
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetStatTotalReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #region 工作量统计明细 
//        [AutoComplete]
//        public long m_lngGetStatDetailReport(System.Security.Principal.IPrincipal p_objPrincipal,string p_strDatFrom,string p_strDatTo,string p_strOprID,
//            out DataTable p_dtbResult)
//        {
//            long lngRes = 0;
//            p_dtbResult = null;
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetStatDetailReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #region 检验费用汇总统计 
//        [AutoComplete]
//        public long m_lngGetCheckPriceTotalReport(System.Security.Principal.IPrincipal p_objPrincipal,string p_strDatFrom,string p_strDatTo,string p_strOprID,
//            out DataTable p_dtbResult)
//        {
//            long lngRes = 0;
//            p_dtbResult = null;
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetCheckPriceTotalReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #region 检验费明细统计 
//        [AutoComplete]
//        public long m_lngGetCheckPriceDetailReport(System.Security.Principal.IPrincipal p_objPrincipal,string p_strDatFrom,string p_strDatTo,string p_strOprID,
//            out DataTable p_dtbResult)
//        {
//            long lngRes = 0;
//            p_dtbResult = null;
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal,"com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetCheckPriceDetailReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetSamplesCheckTotal(System.Security.Principal.IPrincipal p_objPrincipal, out DataTable p_dtbResult, string strDateFrom, string strDateTo)
//        {
//            #region 注释
...
//            return m_lngGetDataTableBySql(p_objPrincipal, out p_dtbResult, strSQL);
//        }
//        #endregion
...
//        /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetGermOccurRate(IPrincipal p_objPrincipal,out DataTable p_dtbResult, string strDateFrom, string strDateTo)
//        {
//            #region 注释
...
//        /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetGermDistributeTrend(System.Security.Principal.IPrincipal p_objPrincipal, out DataTable p_dtbResult, string strDateFrom, string strDateTo)
//        {
...
//            long lngRes = m_lngGetDataTableBySql(p_objPrincipal,out p_dtbResult, strSQL);
...
//           /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetAnimalculeCheckTotal(IPrincipal p_objPrincipal, out DataTable p_dtbResult, string strDateFrom, string strDateTo,ArrayList listSamples,ArrayList listPatientArea)
//        {
//            #region Sql语句
//            string strSQL = @"
...
//        /// <returns></returns>
//        private long m_lngGetDataTableBySql(IPrincipal p_objPrincipal, out DataTable p_dtbResult, string p_strSql)
//        {
//            long lngRes = 0;
//            p_dtbResult = null;
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.LIS.clsStatSvc", "m_lngGetSamplesCheckTotal");
//            if (lngRes < 0)
//            {
//                return -1;
//            }
