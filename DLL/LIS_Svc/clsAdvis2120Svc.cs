...
//        #endregion
        ...
        public long m_lngAddNewCheckItemDeviceCheckItem(System.Security.Principal.IPrincipal p_objPrincipal, clsLisCheckItemDeviceCheckItem_VO p_objRecord)
        {
            ...
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.LIS.clsAdvis2120Svc", "m_lngAddNewCheckItemDeviceCheckItem");
            if (lngRes < 0)
            {
                return -1;
            }
            ...
            clsLisCheckItemDeviceCheckItem_VO p_objRecord)
        {
            ...
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.LIS.clsAdvis2120Svc", "m_lngModifyCheckItemDeviceCheckItem");
            if (lngRes < 0)
            {
                return -1;
            }
        ...
        public long m_lngDelCheckItemDeviceCheckItem(System.Security.Principal.IPrincipal p_objPrincipal, string p_strSourceCheckItemID)
        {
            ...
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            lngRes = objPrivilege.m_lngCheckCallPrivilege(p_objPrincipal, "com.digitalwave.iCare.middletier.LIS.clsAdvis2120Svc", "m_lngDelCheckItemDeviceCheckItem");
            if (lngRes < 0)
            {
                return -1;
            }
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngInsertReport(System.Security.Principal.IPrincipal objPrincipal, int intNum, List<clsAdvia2120ResultInf_VO> p_objResultList, out int p_intInsertNum)
        {
            long lngRes = 0;
            p_intInsertNum = 0;
            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
            objPrivilege.m_lngCheckCallPrivilege(objPrincipal, "com.digitalwave.iCare.middletier.LIS.clsAdvis2120Svc", "m_lngInsertReport");
            if (lngRes < 0)
            {
                return -1;
            }
        ...
        public long m_lngAddCheckResultList(List<string> p_strSampleIDList, string p_strOriginDate)
        {
            ...
            try
            {
                ...
                if (lngRes == 1)
                {
                    ...
                    lngRes = objSampleSv.m_lngUpdateSampleFlag(p_objPrincipal, strSampleIDArr, 3, 5, p_strOriginDate);
                    objSampleSv.Dispose();
                }
            }
            catch (Exception objEx)
